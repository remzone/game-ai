...
- **Сохранения:** формат v3, автоматическая миграция v1/v2 при загрузке. Новый снимок не следует открывать старой версией приложения. Ошибка автосохранения отображается отдельно от результата уже выполненного действия.
